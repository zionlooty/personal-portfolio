        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    ...
                    I'm a dedicated tech enthusiast with 1 years of experience in full-stack web development. I build responsive, user-friendly applications Passionate about solving problems through clean code and continuous learning.
                    </p>
